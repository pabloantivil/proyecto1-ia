...
import numpy as np
from src.data_loader import preparar_datos_main2
from src.rgb_analysis import mostrar_histogramas_estadisticos_main2
from src.bayesian_classifiers import (
    entrenar_bayesiano_rgb_main2, 
    entrenar_bayesiano_pca_main2,
    razon_verosimilitud,
    clasificar_bayes
)
from src.evaluation_metrics import mostrar_curvas_roc_main2, comparacion_final_main2
from src.kmeans_clustering import analisis_completo_kmeans_main2
